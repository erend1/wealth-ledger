...
public sealed class PhysicalGoldSaleModel : PhysicalGoldPageModel
{
    private const int MaximumCostRows = 16;
    private readonly PreviewPhysicalGoldSaleUseCase _preview;
    private readonly RecordPhysicalGoldSaleUseCase _record;

    public PhysicalGoldSaleModel(
        ...
        PreviewPhysicalGoldSaleUseCase preview,
        RecordPhysicalGoldSaleUseCase record,
    ...
    protected override PhysicalGoldWorkflow Workflow => PhysicalGoldWorkflow.Sale;

    public PhysicalGoldSalePreview? Preview { get; private set; }
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!posted)
        {
            ...
            var refreshed = mapping.Sale! with
            {
    ...
    private PhysicalGoldFormMappingResult Map()
        => PhysicalGoldFormMapper.MapSale(
            Input,
            HouseholdId,
            Choices!,
            Custody);
